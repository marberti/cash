...
subroutine shell_help()
  ...
  write(*,*) "                                 At the moment it can only compute volumes of"
  write(*,*) "                                 tetrahedra and octahedra. In the latter case,"
  write(*,*) "                                 vertices must be specified in the following order:"
  write(*,*) "                                                       .v1.                 "
  write(*,*) "                                                     .'/  \'.               "
  write(*,*) "                                                   .' /    \ '.             "
  write(*,*) "                                                 v2--/------\--v5           "
